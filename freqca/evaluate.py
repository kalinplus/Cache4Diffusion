...
def evaluate_all_metrics(
    ...
    assert pickscore_processor_path is not None
    assert pickscore_model_path is not None
        ...
        try:
            ...
            if i < len(prompts):
                ...
                with torch.no_grad():
                    ...
                    score_pickscore = outputs_pickscore.logits_per_image.item()
                    pickscore_scores.append(score_pickscore)
...
def main():
    ...
    parser.add_argument('--reference_folder', type=str, default="/path/to/origin", help='Reference images folder for quality metrics')
    parser.add_argument('--clip_model_path', type=str, default="/path/to/.cache/huggingface/hub/models--laion--CLIP-ViT-g-14-laion2B-s12B-b42K/snapshots/4b0305adc6802b2632e11cbe6606a9bdd43d35c9")
    parser.add_argument('--imagereward_model_path', type=str, default="/path/to/.cache/huggingface/hub/models--zai-org--ImageReward/snapshots/5736be03b2652728fb87788c9797b0570450ab72")
    parser.add_argument('--pickscore_processor_path', type=str, default="/path/to/.cache/huggingface/hub/models--laion--CLIP-ViT-H-14-laion2B-s32B-b79K/snapshots/1c2b8495b28150b8a4922ee1c8edee224c284c0c")
    parser.add_argument('--pickscore_model_path', type=str, default="/path/to/.cache/huggingface/hub/models--yuvalkirstain--PickScore_v1/snapshots/a4e4367c6dfa7288a00c550414478f865b875800")
...
if __name__ == "__main__":
    ...
    # CUDA_VISIBLE_DEVICES=0 python evaluate.py --test_folder samples/test
    # bert-base-uncased