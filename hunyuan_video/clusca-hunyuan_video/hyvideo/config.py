...
def add_inference_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        ...
        type=str,
        default=None,
        help="Path to the vbench JSON file containing prompts.",
    )
    ...
    group.add_argument(
        ...
        type=int,
        default=0,
        help="Start index of prompts to process (inclusive).",
    )
    ...
    group.add_argument(
        ...
        type=int,
        default=0,
        help="End index of prompts to process (inclusive).",
    )
...
def add_cluster_args(parser: argparse.ArgumentParser):
    group = parser.add_argument_group(title="Cluster args")
    group.add_argument('--mode', type=str, default='Taylor', choices=['Taylor-Cache', 'ToCa', 'Taylor', 'ClusCa'], help='Cache mode.')
    group.add_argument('--max-order', type=int, default=1, help='Max order of Taylor expansion.')
    group.add_argument('--fresh-threshold', type=int, default=5, help='Fresh threshold.')
    group.add_argument('--propagation-ratio', type=float, default=0.0, help='Propagation ratio.')
    group.add_argument('--cluster-num', type=int, default=10, help='Number of clusters.')
    group.add_argument('--k', type=int, default=1, help='Number of tokens to fresh per cluster.')
    group.add_argument('--T-wise', action='store_true', help='Use T-wise cluster, i.e. frame-wise cluster.')
    return parser
