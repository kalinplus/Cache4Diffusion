...
class HunyuanVideoPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # print("latents.shape", latents.shape)[1, 16, 17, 60, 80]
        ...
        cache_dic, current = cache_init(self._num_timesteps, model_kwargs=model_kwargs)
            ...
            for i, t in enumerate(timesteps):
                ...
                if cache_dic['test_FLOPs']:
                    ...
                    device_type="cuda", dtype=target_dtype, enabled=autocast_enabled
                        ...
                        flops, macs, params = calculate_flops(model = self.transformer, kwargs = flops_kwargs, print_results=False)
