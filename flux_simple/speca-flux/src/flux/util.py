...
def load_t5(device: str | torch.device = "cuda", max_length: int = 512) -> HFEmbedder:
    ...
    return HFEmbedder("/apdcephfs_jn/share_302243908/jiachengliu/google/t5-v1_1-xxl", max_length=max_length, torch_dtype=torch.bfloat16, weights_only=False).to(device)


def load_clip(device: str | torch.device = "cuda") -> HFEmbedder:
    return HFEmbedder("/apdcephfs_jn/share_302243908/jiachengliu/openai/clip-vit-large-patch14", max_length=77, torch_dtype=torch.bfloat16).to(device)
