#!/bin/bash
# Evaluate SDXL sample outputs against a fixed reference folder.
# Usage: bash evaluate_sdxl.sh [--gpu GPU_ID]
...
TARGET_ROOT="/home/hkl/stable_diffusion_xl/samples"
REFERENCE_FOLDER="/home/hkl/stable_diffusion_xl/samples/taylorseer/S50/N0O0F50"
RESULT_FILE="$TARGET_ROOT/evaluation_results_sdxl.txt"
...
# Recursively evaluate every other image-containing leaf directory against reference.
