...
def score_evaluate(cache_dic: Dict, tokens: torch.Tensor, current: Dict) -> torch.Tensor:
    '''
    ...
    cache_type = cache_dic.get('cache_type', 'random')
