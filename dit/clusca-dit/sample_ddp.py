...
def main(args):
    ...
    folder_name = f"ClusCa-{model_string_name}-{ckpt_string_name}-size-{args.image_size}-vae-{args.vae}-" \
                  ...
                  f"-{args.cluster_method}-{args.cluster_num}-{args.propagation_ratio}"
...
if __name__ == "__main__":
    ...
    # ClusCa arguments
    parser.add_argument("--cluster-num", type=int, default=16, help="Number of clusters to use for ClusCa. If 0, disable ClusCa.")
    parser.add_argument("--cluster-method", type=str, choices=['kmeans', 'random', 'kmeans++'], default='kmeans')
    parser.add_argument("--propagation-ratio", type=float, default=0.005)
