...
class GaussianDiffusion:
    ...
    def ddim_sample_loop_progressive(
        ...
        """
        使用从0开始的索引顺序进行DDIM采样，但保持逻辑不变
        """
        global total_flops, processed_samples
        ...
        if cache_dic['test_FLOPs'] == True:
           print(cache_dic['flops'] * 1e-12, "TFLOPs")
           processed_samples += 1
           total_flops += cache_dic['flops'] 
           print(f"avg FLOPs: {(total_flops/processed_samples) * 1e-12:.4f} TFLOPS")
           print(f"total FLOPs: {(total_flops) * 1e-12:.4f} TFLOPS")
