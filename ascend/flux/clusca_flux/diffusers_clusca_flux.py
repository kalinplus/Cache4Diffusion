...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Single-prompt inference for FLUX with ClusCa overrides")
...
def main() -> None:
    ...
    if args.enable_cpu_offload:
        raise NotImplementedError("CPU offload is not supported for ClusCa yet.")
