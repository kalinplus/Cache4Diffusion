...
def main():
    ...
    parser.add_argument('--clip_model_path', type=str, default="/mnt/data0/pretrained_models/laion/CLIP-ViT-g-14-laion2B-s12B-b42K")  # forexample, /data/public/models/laion/CLIP-ViT-g-14-laion2B-s12B-b42K
    parser.add_argument('--imagereward_model_path', type=str, default="data0/pretrained_models/zai-org/ImageReward")
