...
if __name__ == '__main__':
    ...
    parser.add_argument('--rel_l1_thresh', type=float, default=1.6, help='TeaCache relative L1 threshold, 0.25 for 1.5x speedup, 0.4 for 1.8x speedup, 0.6 for 2.0x speedup, 0.8 for 2.25x speedup')
