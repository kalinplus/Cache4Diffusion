...
class SamplingOptions:
    ...
    fresh_ratio: float          # Fresh ratio
    soft_fresh_weight: float    # Soft fresh weight
    ...
    for batch_idx in range(num_prompt_batches):
        ...
        for image_idx in range(opts.num_images_per_prompt):
            ...
            cache_dic, current = cache_init(kwargs={
                ...
                'fresh_ratio': opts.fresh_ratio,
                'soft_fresh_weight': opts.soft_fresh_weight,
            })
...
if __name__ == '__main__':
    ...
    parser.add_argument('--interval', type=int, default=8, help='Interval.')
    parser.add_argument('--first_enhance', type=int, default=3, help='First enhance steps.')
    parser.add_argument('--fresh_ratio', type=float, default=0.25, help='Fresh ratio.')
    parser.add_argument('--soft_fresh_weight', type=float, default=0.25, help='Soft fresh weight.')
