...
def pipeline_with_cache(pipe):
    ...
    from pipeline.transformer_qwenimage import QwenDoubleStreamAttnProcessor2_0 as LocalQwenDoubleStreamAttnProcessor2_0
    ...
    for _, block in enumerate(pipe.transformer.transformer_blocks):
        ...
        block.attn.processor = LocalQwenDoubleStreamAttnProcessor2_0()
