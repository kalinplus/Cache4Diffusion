...
class SamplingOptions:
    ...
    fc_start_step: int          # First step to start caching
    fc_interval: int            # Cache period length
    fc_alpha: float             # Linear extrapolation coefficient
...
def main(opts: SamplingOptions):
    ...
    for i in range(len(prompts)):
        ...
        kwargs = {
            ...
            'fc_start_step': opts.fc_start_step,
            'fc_interval': opts.fc_interval,
            'fc_alpha': opts.fc_alpha,
        }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fc_start_step', type=int, default=3)
    parser.add_argument('--fc_interval', type=int, default=6)
