...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if current['type'] == 'full':
            ...
            cache_store(cache_dic['cache'][-1][current['module']][current['submodule']][current['subsubmodule']][current['idx']][current['subidx']][current['subsubsubmodule']], attn_output)
            ...
            cache_store(cache_dic['cache'][-1][current['module']][current['submodule']][current['subsubmodule']][current['idx']][current['subidx']][current['subsubsubmodule']], ff_output)
            ...
            gligen_kwargs = cross_attention_kwargs.pop("gligen", None)
            current['subsubsubmodule'] = 'attn1'
            attn_output = cache_predict(cache_dic['cache'][-1][current['module']][current['submodule']][current['subsubmodule']][current['idx']][current['subidx']][current['subsubsubmodule']], cache_dic['fc_alpha'])
            hidden_states = attn_output + hidden_states
            if hidden_states.ndim == 4:
                hidden_states = hidden_states.squeeze(1)
            if gligen_kwargs is not None:
            ...
            current['subsubsubmodule'] = 'mlp'
            ff_output = cache_predict(cache_dic['cache'][-1][current['module']][current['submodule']][current['subsubmodule']][current['idx']][current['subidx']][current['subsubsubmodule']], cache_dic['fc_alpha'])
            hidden_states = ff_output + hidden_states
            if hidden_states.ndim == 4:
                hidden_states = hidden_states.squeeze(1)
